...
class SummaryFacade
{
    ...
    public function getOverviewData() : array
    {
        ...
        $data["total"] = [
            ...
            'averageAttemptsPerStudent' => $totalTaskNameCount > 0 ? round($averageAttemptsPerStudentTotal / $totalTaskNameCount, 1) : 0,
        ];
